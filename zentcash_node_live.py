...
DBHOST = os.getenv('NODEZTC_MYSQL_HOST', 'localhost')
DBUSER = os.getenv('NODEZTC_MYSQL_USER', 'user')
DBNAME = os.getenv('NODEZTC_MYSQL_NAME', 'dbname')
DBPASS = os.getenv('NODEZTC_MYSQL_PASS', 'dbpassword')
        
REMOTE_NODES_URL = "https://raw.githubusercontent.com/ZentCashFoundation/zentcash-nodes-json/master/zentcash-nodes.json"
SLEEP_CHECK = 30  # 30 s
NODE_LIVE_LIST = []
